...
export function NovoAnalista() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Aqui você adicionaria a lógica para salvar o analista
    console.log('Novo analista:', formData);
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[var(--theme-muted-foreground)] mt-1">
            Cadastre um novo analista no time
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="maria.silva@itau.com.br"
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <Textarea
              id="observacoes"
              placeholder="Informações adicionais sobre o analista..."
